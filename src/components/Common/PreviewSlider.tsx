...
const PreviewSliderModal = () => {
  ...
  // 1. Get the product details from the Redux store
  ...
  // 2. Add a check to ensure product data exists before rendering
  if (!product) {
    return null
  }
      ...
      <Swiper ref={sliderRef} slidesPerView={1} spaceBetween={20}>
        <SwiperSlide>
          <div className="flex justify-center items-center">
            <Image
              // 3. Use dynamic image URL and provide a fallback
              src={product.image_url || '/images/products2/BN 8.8 MM.jpg'}
              // 4. Use dynamic alt text
        ...
        {/* If your product object has an array of images, you can map them here
         e.g., product.gallery.map(img => <SwiperSlide>...</SwiperSlide>) */}
      </Swiper>
    </div>
  )
}
